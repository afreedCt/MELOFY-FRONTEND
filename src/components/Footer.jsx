...
const Footer = () => {
  return (
    <div>
      <div className="bg-info ps-3 p-2 ">
        ...
        <div className="row">
          <div className="col-lg-6 px-3 py-2 text-white justify-right">
            <p style={{textAlign:"justify"}}>
              ...
              recusandae eaque, officia deleniti tempore.Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla
              possimus ad voluptatum dicta? Quam quis corrupti placeat
              consequatur fugiat aut consequuntur molestias, assumenda esse ea
              recusandae eaque, officia deleniti tempore.
            </p>
          </div>
          <div className="col-lg-6 row gap-4 gap-md-0 py-1">
            <div className="col-md-4 col-sm-6">
              <h2 className="fw-bold" style={{color:"blueviolet"}}>Links</h2>
              <Link
                to={"/"}
            ...
            <div className="col-md-4 col-sm-6">
              <h2 className="fw-bold" style={{color:"blueviolet"}}>>Guides</h2>
            ...
            <div className="col-md-4 ">
              <h2 className="fw-bold" style={{color:"blueviolet"}}>Contact us</h2>
        ...
        <p className="mt-3 text-center text-white">copyright &copy; julay 2025, media player , built with react</p>
      </div>
    </div>
  );
};
